...
<div class="animsition">
    ...
    <div class="menu">
        ...
        <div class="menu-footer right-boxed">
            ...
            <div class="copy"> ©2021<a href="https://digitalmoon.al/" target="_blank"> Digital Moon Agency </a> All Rights Reserved</div>
        </div>
    </div>
    ...
    <div class="copy-bottom white boxed">  ©2021<a href="https://digitalmoon.al/" target="_blank"> Digital Moon Agency </a> </div>
    ...
    <div class="pagepiling">
        ...
        <div data-anchor="page2" class="pp-scrollable section section-2">
            <div class="scroll-wrap">
                <div class="scrollable-content">
                    <div class="vertical-title text-white  d-none d-lg-block"><span>shkembimi</span></div>
                    <div class="vertical-centred">
                        <div class="boxed boxed-inner">
                            <div class="boxed">
                                <div class="container">
        ...
        <div data-anchor="page3" class="pp-scrollable text-white section section-3">
            <div class="scroll-wrap">
                <div class="section-bg mask" style="background-image:url('/assets/images/drilon/about2.png')"></div>
                <div class="scrollable-content">
                    <div class="vertical-title d-none d-lg-block"><span>about </span></div>
                    <div class="vertical-centred">
                        <div class="boxed boxed-inner">
                            <div class="boxed">
                                <div class="container">
                                    <div class="intro">
                                        <div class="row row-resume">
                                            <div class="col-md-6 fadeY fadeY-1">
                                                <h2 class="resume-header title">About</h2>
                                            ...
                                            <div class="col-md-6 pt-md-5 mt-md-5 fadeY fadeY-2">
                                                <h2 class="resume-header title">PRODUCTION</h2>
                                                <div class="col-resume">
                                                    <div class="resume-content">
                                                        <div class="resume-inner">
                                                            <div class="resume-row">
        ...
        <div data-anchor="page4" class="pp-scrollable text-white section section-5">
            <div class="scroll-wrap">
                ...
                <!--          </div>-->
                <div class="scrollable-content">
                    <div class="vertical-title  d-none d-lg-block"><span>production</span></div>
                    <div class="vertical-centred">
                        <div class="boxed boxed-inner">
                            <div class="boxed">
                                <div class="container">
